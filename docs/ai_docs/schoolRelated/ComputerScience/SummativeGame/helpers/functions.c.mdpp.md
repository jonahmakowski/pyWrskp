# Documentation for src/schoolRelated/ComputerScience/SummativeGame/helpers/functions.cpp

# AI Summary
This file contains various utility functions for handling game objects, panels, and camera operations in a game developed using the Allegro library. It includes functions for drawing objects and panels, checking collisions, updating positions, and managing camera movements. The functions are designed to work with custom structs like Object, Panel, Tower, and Enemy, and they utilize Allegro's graphics and input handling capabilities.
...
The code is generally well-structured and functional, but there are some issues with naming conventions and a few syntax errors that need to be addressed.
# Functions

## pressing_keybind
### Explanation
Checks if the key pressed in the event is one of the keycodes in the keybind
### Code
```cpp
