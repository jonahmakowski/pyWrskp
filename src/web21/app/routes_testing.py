...
'''
@app.route('/home/cac?num1=<num_1>&type=<type>&num2=<num_2>', methods=['POST', 'GET'])
...
@app.route('/home/cac/a', methods=['POST', 'GET'])
def caculator():
    num_1 = request.forms.get('num1')
    num_2 = request.forms.get('num2')
