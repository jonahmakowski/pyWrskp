...
class Sender:
    ...
    def create_note(self):
        ...
        destroy = input(
            "Would you like the file to be destoryed after reading?\n"
        ...
        for i in range(5):
            ...
            for c in range(random.randint(6, 20)):
                new_item = ""
                while (new_item != "}" and new_item != "{") and (
                    new_item != "[" and new_item != "]"
                ):
                    new_item = self.remote_coder.abcs[
                        random.randint(0, len(self.remote_coder.abcs) - 1)
                    ]
                    item += new_item
            items.append(item)
    ...
    def read_note(self):
        ...
        if destroy == "y":
            ...
            print(
                "The person who sent you this .txt file has decieded that it is not nessary to delete the file,"
            )
