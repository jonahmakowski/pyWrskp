...
class Log:
    ...
    def add(self):
        ...
        post_date = "{}-{}-{}".format(
            current_log["date"]["month"],
            current_log["date"]["day"],
            current_log["date"]["year"],
        )
        print(
            "your message, {} and the time and date, {}, {}, have been saved!".format(
    ...
    def read(self):
        ...
        if unreadable > 0:
            print("\n\n")
            print(
                "There are {} log entries that were either from an older version, or were entered directly into "
