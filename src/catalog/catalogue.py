...
class catalog:
    def __init__(self, books):
        ...
        while True:
            ...
            new_author = input(
                "Please write the name of the author that the book is written by:   "
            )
    ...
    def start(self):
        try:
            ...
            print(
                'could not find your "data.txt" file, please make sure it is in the same folder as this file'
            )
            print(
                'if you have not created a "data.txt" file or, have not run this code before, ignore this message'
            )
            self.old_books = []
            fuction.wait()
        self.show()
