...
class Games:
    ...
    def math(self):
        ...
        print(
            "The current high score is {} by user {}!".format(
                pyWrskp.read_file("math.txt")["score"],
                pyWrskp.read_file("math.txt")["user"],
            )
        )
        print(
            "If you respond anything greater or equal than 1000001, you will get your results"
        )
        score = 0
        while True:
            ...
            if operation == 1:
                ...
                question = "{} / {}".format(num1, num2)
                awnser = num1 / num2
            user_input = pyWrskp.number_input(question, t="float", tell=False)
        ...
        if score >= pyWrskp.read_file("math.txt")["score"]:
            ...
            pyWrskp.write_file("math.txt", {"score": score, "user": self.user})
