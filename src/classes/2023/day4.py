...
while True:
    ...
    if guesses.isdigit():
        ...
        print(
            "That is obviously supposed to be a number, you should be ashamed of yourself."
        )

print(
    "Welcome to guess my number {}! You have {} guesses! The number is betweeen 0, and 100".format(
        name, guesses
    )
)
...
options = [
    {
        ...
        "beats": "scissors",
        "lose": "paper",
    },  # change this dictionary to make your own version!
