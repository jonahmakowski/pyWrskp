while True:
    ...
    if amount.isdigit():
        ...
        print(
            "You really are a BIG student, that is not a number!",
...
print(
    "Way 2"
)  # Way I would use before this class (since I did not know about the end paramater in the print function)
...
print(
    "Way 1"
)  # Did this before I saw the assignment, does not really follow the critrea of the extra assignment
