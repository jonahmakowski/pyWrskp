...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.btnSaveas = tk.Button(
            self.btnFrame, text="Save as", command=self.save_file
        )
        self.btnquit = tk.Button(
            self.btnFrame, text="Close", command=self.master.destroy
        )
    ...
    def open_file(self):
        ...
        self.fp = askopenfilename(
            filetypes=[
                ("all files that work with this code", ["*.py", "*.txt", "*.docx"]),
                ("Text Files", "*.txt"),
                ("Python Files", "*.py"),
                ("All Files", "*.*"),
            ]
