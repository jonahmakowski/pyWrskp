...
class app(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.btnpaint_2 = tk.Button(
            self.btnFrame, text="Paint v2", command=self.paint_2
        )
        self.btnhome = tk.Button(self.btnFrame, text="Home stuff", command=self.home)
        self.btntextedit = tk.Button(
            self.btnFrame, text="text editer", command=self.text_edit
        )
