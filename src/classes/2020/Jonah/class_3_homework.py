class House:
    ...
    def what_to_do(self):
        ideas = [
            "go on a walk to pick up the mail",
            "play on your device",
            "watch a movie",
            "go to a park",
        ]
    ...
    while True:
        ...
        if what_do == ("add new family members"):
            ...
            if change <= len(houses) - 1:
                ...
                i = len(houses) - 1
                print(
                    "The valuse you entered is too high, you have been put at your possible value."
                )
                print(
                    'To create more house please enter "create new house" the next time the "What would you like to do?" question pops up'
                )
