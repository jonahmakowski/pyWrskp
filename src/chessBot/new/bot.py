...
def m1_analyser(game: Game, piece, move, side):
    ...
    opponent_best_piece, opponent_best_move = artificial_semi_intelligence(
        move_game, side=enemy_side
    )
    opponent_best = make_move_into_game(
        move_game, opponent_best_piece, opponent_best_move
    )
