...
class MarkingCalculator:
    ...
    def create_screen(self):
        layout_tab_one = [
            [
                sg.Text(
                    "Convert your marks to percentage",
                    expand_x=True,
            ...
            [
                sg.Text("Input The Maximum Mark: "),
                sg.InputText(key="-MAX-MARK-", expand_x=True),
            ],
            [sg.Button("Convert"), sg.Button("Exit")],
            [
                sg.Text(
                    'Your result goes here: (None Yet! Press the "Convert" button to start!)',
                    key="-Percent-Result-",
                )
            ],
        ]
        layout_tab_two = [
            [
                sg.Text(
                    "Enter your grades (in percentages) on new lines in the box below:",
                    expand_x=True,
                    justification="center",
                )
            ],
            ...
            [
                sg.Text(
                    "Enter the values (in percentages) of each grade below, in the same order:",
                    expand_x=True,
                    justification="center",
                )
            ],
            ...
            [
                sg.Text(
                    'Your result goes here: (None Yet! Press the "Calculate" button to start!)',
                    key="-Combine-Result-",
                )
            ],
        ]
        ...
        main_layout = [
            [
                sg.TabGroup(
                    [
                        [
                            sg.Tab("Marks > Percentage", layout_tab_one),
            ...
            if event == sg.WIN_CLOSED or "Exit" in event:
                ...
                if not (values["-MARK-"].isdigit() or values["-MAX-MARK-"].isdigit()):
                    ...
                    if int(values["-MARK-"]) == 0 or int(values["-MAX-MARK-"]) == 0:
                        ...
                        result = self.mark_to_percent(
                            float(values["-MARK-"]), float(values["-MAX-MARK-"])
                        )
                    self.window["-MARK-"].update("")
                    self.window["-MAX-MARK-"].update("")
                    self.window["-Percent-Result-"].update(
                        "Your result goes here:  {}".format(result)
                    )
                ...
                if (len(grades) == 1 or len(grade_values) == 1) and (
                    grades[0] == "" or grade_values[0] == ""
                ):
                    ...
                    for index in range(len(grades)):
                        if not (
                            grades[index].isdigit() or grades_values[index].isdigit()
                        ):
                        ...
                        new.append(
                            {
                                ...
                                "value": float(grade_values[index]),
                            }
                        )
                ...
                if not invalid:
                    ...
                    if not result:
                        ...
                        self.window["-Combine-Result-"].update(
                            "Your result goes here:  {}".format(result)
                        )
