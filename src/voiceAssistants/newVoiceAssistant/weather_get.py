...
def parse_forecast(data):
    ...
    for idx, time in enumerate(hourly_times):
        ...
        daily_precipitation[day_idx] = max(daily_precipitation[day_idx], hourly_precipitation[idx])
    ...
    return daily_times, daily_temps, daily_low_temps, daily_precipitation, daily_avg_temp, current_temp, current_weather_code
...
def get_weather():
    ...
    if data:
        ...
        if forecast_data:
            daily_times, daily_temps, daily_low_temps, daily_precipitation, daily_avg_temp, current_temp, current_weather_code = forecast_data
            for index, day in enumerate(daily_times):
                data_out[day] = {"daily_temps": daily_temps[index], 
            ...
            data_out["current_weather"] = weather_code_to_description(current_weather_code)
