...
class CommandExecution:
    ...
    def setup(self):
        ...
        self.assistant_name = 'Assistant'  # This is used by the speak function in the printout
...
class Main:
    ...
    def main_setup(self):
        ...
        self.inputtxt = tk.Text(self.frame,
                                ...
                                width=35,
                                wrap=tk.WORD)
        self.sendbutton = tk.Button(self.frame,
                                    text="Send",
                                    command=self.get_input)
        self.speakbutton = tk.Button(self.frame,
                                     text='Audio',
