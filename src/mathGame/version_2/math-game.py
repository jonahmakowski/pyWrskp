...
class MathGame:
    ...
    def mainloop(self):
        ...
        print(
            "Out of the {} questions you did, {} were right, and {} were wrong!".format(
                self.total_questions, self.correct, self.incorrect
            )
        )
...
math = MathGame(
    int(input("What would you like the largest number to be?")),
    ...
    save=True,
)  # this is if or if not to save the score
math.mainloop()
