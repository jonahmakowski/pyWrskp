...
var2 = int(input()) # takes input from the question put in the bracket (this saves as a int), the int() part takes the input and turns it into a int, if it is a word, like "Hello", it will return an error, if it is a float like "0.5" it will also return an error

var3 = float(input()) # takes input from the question put in the bracket (this saves as a float), the float() part takes the input and turns it into a float, if it is a word, like "Hello", it will return an error, if it is a int like "1" it will make the int, "1" into "1.0"
