...
class Kingdom:
    ...
    def mainloop(self):
        ...
        while True:
            ...
            if (self.people <= 0 or self.happiness <= 0) or (
                self.money <= 0 or self.resources <= 0
            ):
                print("You lost!")
                print("Game Over!")
                break
            ...
            if (self.people > 100 or self.happiness > 100) or (
                self.money > 100 or self.resources > 100
            ):
                if self.people > 100:
                    self.people = 100
