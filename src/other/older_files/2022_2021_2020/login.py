...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.btns = [
            tk.Button(self.btnFrame, text="1", command=self.one),
...
class System(tk.Frame):
        ...
        self.btns = [
            {
                "loc": [10, 10],
                "item": tk.Button(
                    self.btnFrame, text="log out", command=self.master.destroy
                ),
            },
            {
                "loc": [0, 0],
                "item": tk.Button(self.btnFrame, text="Info", command=self.info),
            },
        ]
        self.create_buttons()
    ...
    def info(self):
        ...
        print(
            "~~~~~~~~~~~~~~~~~~~~~~ This system is owned and run by Jonah Makowski ~~~~~~~~~~~~~~~~~~~~~~"
        )
        print(
            "~~~~~~~~~~~~~~~~~~~~~~                                                ~~~~~~~~~~~~~~~~~~~~~~"
        )
...
if app.active and app.pas == app.code:
    ...
    if (name == "Jonah" or name == "Noah") or (
        name == "Jonah Makowski" or name == "Noah Makowski"
    ):
        sleep(2.5)
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
