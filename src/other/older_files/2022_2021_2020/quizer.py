...
class Quiz:
    def __init__(self):
        self.a = [
            {
                "w": "Scavengers",
                "d": "an animal or other organism that feeds on dead organic matter.",
            },
            {
                "w": "Photosynthesis",
            ...
            {
                "w": "Primary Consumers",
                "d": "an animal that feeds on plants; a herbivore.",
            },
            {
                "w": "Decomposers",
            ...
            {
                "w": "Community",
                "d": "an assemblage of interacting populations occupying a given area.",
            },
            {
                "w": "Producers",
            ...
            {
                "w": "Secondary Consumers",
                "d": "a carnivore that feeds only on herbivores.",
            },
        ]
        self.correct = 0
        self.wrong = 0
