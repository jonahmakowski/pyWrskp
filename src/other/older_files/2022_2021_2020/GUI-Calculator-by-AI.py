...
def main():
    ...
    button_clear = tk.Button(
        window, text="AC", font=("Calibri", 20), width=5, height=2, command=button_clear
    )
    button_equal = tk.Button(
        window, text="=", font=("Calibri", 20), width=5, height=2, command=button_equal
    )
    button_fraction = tk.Button(
        window,
        text="Fraction",
        font=("Calibri", 10),
        width=11,
        height=2,
        command=button_fraction,
    )
