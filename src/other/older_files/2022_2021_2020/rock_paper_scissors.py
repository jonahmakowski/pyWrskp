...
class RockPaperScissors:
    ...
    def player_choose(self):
        ...
        while True:
            self.player_choice = input(
                "What would you like to choose (paper, rock, scissors)?"
            )
            if (
                self.player_choice == "paper" or self.player_choice == "rock"
            ) or self.player_choice == "scissors":
                break
            else:
    ...
    def show_winner(self):
        if (
            (
                (self.player_choice == "rock" and self.computer_choice == "paper")
                or (self.player_choice == "scissors" and self.computer_choice == "rock")
            )
            or self.player_choice == "paper"
            and self.computer_choice == "scissors"
        ):
            print("You Lose")
            s(2)
            print(
                "the computer choose {} and you choose {}".format(
                    self.computer_choice, self.player_choice
                )
            )
        elif (
            (
                (self.computer_choice == "rock" and self.player_choice == "paper")
                or (self.computer_choice == "scissors" and self.player_choice == "rock")
            )
            or self.computer_choice == "paper"
            and self.player_choice == "scissors"
        ):
            print("You win")
            s(2)
            print(
