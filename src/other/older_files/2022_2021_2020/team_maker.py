...
class TeamMaker:
    def __init__(self, loc, t=None, d=None, pr=True):
        ...
        while True:
            ...
            if t == "2 teams":
                ...
                print('"partners"')
                print(
                    'or if you add "+ captions" to any of them you will get one caption per team'
                )
                print("asking again\n\n")
    ...
    def ask_l(self):
        ...
        if load == "n":
            print(
                "Enter a list of the people's names if nothing is entered, the list will stop, you must include "
                "more than one name"
            )
            while True:
                l_add = input("")
    ...
    def load(self):
        try:
            ...
            print(
                "This file, where the save is does not exist, to use this program make a file at {}.".format(
                    self.name
                )
            )
            exit(5)
